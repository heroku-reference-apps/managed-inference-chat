...
import { PaperAirplaneIcon, StopIcon, PlusIcon } from '@heroicons/react/24/solid';
...
const Chat: React.FC = () => {
  const [selectedModel, setSelectedModel] = useState<ModelType>('claude-4-sonnet');
  ...
  const handlePredefinedPromptSelect = async (predefinedPrompt: PredefinedPrompt) => {
    // Set the model and tools based on the predefined prompt
    setSelectedModel(predefinedPrompt.model);
    ...
    <div className='h-[calc(100vh-3rem)] flex items-center justify-center p-4'>
      <div
        className={clsx(
          ...
          messages.length === 0 ? 'max-w-5xl h-[600px]' : 'max-w-5xl h-full'
        )}
      >
              ...
              <div className='flex flex-col gap-2'>
                ...
                <div className='flex items-center gap-3 justify-end'>
                  ...
                  <select
                    ...
                    disabled={isLoading}
                  >
                    {availableModels.map((model: ModelType) => (
